...
def upgrade() -> None:
    ...
    # Create admin_crypto_wallets table if not exists
    if 'admin_crypto_wallets' not in existing_tables:
        op.create_table(
    ...
    # Create credit_purchase_requests table if not exists
    if 'credit_purchase_requests' not in existing_tables:
        op.create_table(
